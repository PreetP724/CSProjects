...
public class FilterLower48 implements FilterAirport {
	...
	public boolean accept(String country, GPS gps) {
		if(country.equals("United States") && gps.latitude >= 24.5231 && gps.latitude <= 46.29204 && gps.longitude >= -124.41 && gps.longitude <= -66.9499) {
			return true;
		}
		return false; // REPLACE WITH SOMETHING THAT ONLY ACCEPTS AIRPORTS FROM LOWER 48 OF UNITED STATES
	}
}
