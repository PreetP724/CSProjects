...
public class Analysis {
	...
	static long model(int n) {
		return  (long) (5*n + n*((Math.log(n)/Math.log(2))/2) - 2);  // FILL IN YOUR MODEL FORMULA
	}
	...
	public static void main(String[] args) {
		...
		for (int n = 2; n <= 1024; n*=2) {
			...
			System.out.println(String.format("%6d %20d %20d %20d", n, val, numPower, model(n)));
		}
	}
}
